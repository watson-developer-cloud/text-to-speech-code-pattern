...
<h2>
  This code pattern is no longer supported. You can find the newly supported Text to Speech Code Pattern
  <a href="https://github.com/IBM/text-to-speech-code-pattern">
    here.
  </a>
</h2>
